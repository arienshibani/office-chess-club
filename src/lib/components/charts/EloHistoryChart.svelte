<script>
	import { buildEloChartGeometry, formatChartDate, formatChartTooltipDate } from '$lib/chess/elo-history.js';

	/** @type {{ points?: import('$lib/chess/elo-history.js').EloHistoryPoint[] }} */
	let { points = [] } = $props();
